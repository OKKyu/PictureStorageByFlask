...
def before_request():
    ...
    app.logger.debug("-get data body-")
    app.logger.debug(request.get_data())
    
    app.logger.debug("-request forms key and values-")
...
if __name__ == '__main__':
    ...
    app.run(host='192.168.1.53', port=5001)
else:
